---
title: LLM Analysis Quiz Solver(p2)
emoji: 👀
colorFrom: indigo
colorTo: blue
sdk: docker
...
**Author**: Pavan Kumar Yadav  
**Course**: Tools in Data Science (TDS)
**Institution**: IIT Madras

For questions or issues, please open an issue on the [GitHub repository](https://github.com/PAVAN2005-LAB/TDS_P2_SEP_2025/).
